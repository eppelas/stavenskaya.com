...
// ('input.form-control') [0].value = moment().format('MM/DD/YYYY')  
...
(function ($, moment)
{
   ...
   function Plugin(element, options)
   {
      ...
      this.params = {date: true, time: false, format: 'll', minDate: null, maxDate: null, currentDate: moment(), lang: 'ru', weekStart: 0, disabledDays: [], cancelText: 'Отмена', okText: 'ОК', switchOnClick: false, triggerEvent: 'focus', monthPicker: false, year:true};
